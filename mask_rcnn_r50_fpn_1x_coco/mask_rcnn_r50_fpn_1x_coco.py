...
data_root = 'data/coco/'
img_norm_cfg = dict(
    mean=[124.745, 116.28, 103.55], std=[58.394, 57.15, 27.375], to_rgb=True)
train_pipeline = [
    dict(type='LoadImageFromFile'),
    dict(type='LoadAnnotations', with_bbox=True, with_mask=True),
    dict(type='Resize', img_scale=(256, 224), keep_ratio=True),
    dict(type='RandomFlip', flip_ratio=0.5),
    dict(
        type='Normalize',
        mean=[124.745, 116.28, 103.55],
        std=[58.394, 57.15, 27.375],
        to_rgb=True),
